    ...
    fetch("/api/sign-up", requestOptions)
      ...
      .then((result) => {
        if (result.isSaved) {
          ...
          else if (!result.isPWValid) {
            alert("Password needs to be at least 3 characters");
          }
          // if userName not good
          else if (!result.isUserNameValid) {
            alert("User name taken, try a different one");
          } else {
